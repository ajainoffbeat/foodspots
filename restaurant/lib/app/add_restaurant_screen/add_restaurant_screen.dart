        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                Visibility(
                  visible: controller.vendorModel.value.subscriptionPlan?.features?.qrCodeGenerate != false,
                  child: Padding(
            ...
            bottomNavigationBar: (Constant.getEmployeeRolePermission(module: "Restaurant Information's", pType: ActionType.isAdd) == false)
                ? null
                : Container(
                    color: themeChange.getThem() ? AppThemeData.grey900 : AppThemeData.grey50,
