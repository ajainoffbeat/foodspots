...
class Constant {
  ...
  static List<PermissionModel> permissionList = [
    PermissionModel(title: 'Add Story', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Advertisement', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: "Restaurant Information's", isView: false),
    PermissionModel(title: 'Manage Products', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Woking Hours', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Withdraw Method', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Manage Delivery Man', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Employee Role', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'All Employee', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Add Dine in', isAdd: false, isView: false),
    PermissionModel(title: 'Dine in Request', isAdd: false, isView: false),
    PermissionModel(title: 'Offers', isAdd: false, isView: false, isDelete: false),
    PermissionModel(title: 'Special Discounts', isAdd: false, isView: false, isDelete: false),
