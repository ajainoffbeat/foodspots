...
class FireStoreUtils {
  ...
  Future<void> getSettings() async {
    try {
      ...
      FirebaseFirestore.instance.collection(CollectionName.settings).doc("scheduleOrderNotification").get().then((time) {
        if (time.exists) {
      ...
      FirebaseFirestore.instance.collection(CollectionName.settings).doc("ContactUs").get().then((time) {
        if (time.exists) {
