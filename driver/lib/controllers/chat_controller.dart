...
class ChatController extends GetxController {
  ...
  Future<void> getArgument() async {
    ...
    if (argumentData != null) {
      ...
      receiverUser.value = await FireStoreUtils.getUserProfile(senderId.value);
    }
    setSeen();
  ...
  Future<void> sendMessage(String message, Url? url, String videoThumbnail, String messageType) async {
    ...
    SendNotification.sendChatFcmMessage(senderName.value, conversationModel.message.toString(), receiverUser.value?.fcmToken ?? '', {});
  }
