                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ((controller.orderModel.value.takeAway == true || Constant.userModel?.vendorID?.isNotEmpty == true))
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                "Delivery Fee${controller.orderModel.value.isFreeDelivery == true ? " (Customer)" : " (Admin)"}".tr,
                                                textAlign: TextAlign.start,
                                                style: TextStyle(
                                                  fontFamily: AppThemeData.regular,
                                                  color: themeChange.getThem() ? AppThemeData.grey300 : AppThemeData.grey600,
                                  ...
                                  ((controller.orderModel.value.takeAway == true || Constant.userModel?.vendorID?.isNotEmpty == true) || controller.orderModel.value.isFreeDelivery == true)
                                      ? const SizedBox()
                                      : Row(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
