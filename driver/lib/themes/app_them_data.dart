...
class AppThemeData {
  ...
  static const Color driverApp100 = Color(0xFFEFF9EB);
  static const Color driverApp200 =Color(0xFFEFF9EB);
  // static Color driverApp300 = const Color(0xFF5BC236);
  static Color driverApp300 =Color(0xFFEFF9EB);
  static const Color driverApp400 = Color(0xFFEFF9EB);
  static const Color driverApp500 = Color(0xFFEFF9EB);
  ...
  static const Color grey50 = Color(0xFFF3F4F6); // exact logo orange
